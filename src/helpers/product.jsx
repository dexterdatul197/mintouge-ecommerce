// get products
export const getProducts = (products, categories, category, type, limit) => {
  const categoryId = categories.find((single) => single.name === category)?.id;
...
export const getDiscountPrice = (product, rewards) => {
  ...
  const discountRewards = rewards.filter(_reward => _reward.category === "Discount" && _reward.isActive);
...
export const getIndividualTags = (products) => {
  let productTags = ["fashion", "bag", "women"];
  // products &&
  //   products.map((product) => {
  //     return (
  //       product.tags &&
...
export const getIndividualColors = (products) => {
  let productColors = ["white", "black", "brown"];
  // products &&
  //   products.map((product) => {
  //     return (
  //       product.variation &&
